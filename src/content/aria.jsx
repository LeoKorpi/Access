...
<div>
  ...
  <p>
    ...
    <span className="text-bold">Accessible Rich Internet Applications</span>. It
    is a set of attributes that can be added to HTML-elements to make web
    content accessible to users who use assistive technologies &#40;AT&#41;.
    Below we'll dive deeper into what ARIA is, when to, and when to not use it.
  </p>
  <h2>What is ARIA?</h2>
  <p>
    Thanks to ARIA we can give semantic descriptions to content which doesnt
    natively exist in HTML or is missing full browser support. Simply put, ARIA
    was created for users who cannot use a mouse and must rely on their keyboard
    when browsing the web. When accessibility issues cannot be resolved with
    native HTML, ARIA can be utilized to patch things up.
  </p>
  <p>
    ...
    &#40;WAI-ARIA&#41;. It is a technical specification published by the World
    Wide Consortiom &#40;W3C&#41; and the current recommendation to follow is{" "}
    <Link
  ...
  <h3>Roles</h3>
  <p>
    Roles are defined and described by their characteristics. These define the
    structural function of a role, such as what a role is, concepts behind it
    and what instances the role can or must contain. Some examples of this are:
  </p>
  <ul>
    <li>
      ...
      <ul>
        <li role="none">
          ...
          identify content while navigating through a page and provides context
    ...
    <li>
      ...
      <ul>
        <li>
          Created for easier navigation by providing identifiable landmarks for
          sections of content within a page. A screen reader will for example
          announce the start and end of each landmark-role set on a page.
        </li>
        <li>
    ...
    <li>
      ...
      <ul>
        <li>
          When naturtal HTML can't define elements widget roles are used to give
          semantic meaning to user interfaces &#40;UIs&#41;. These are in turn
          divided into standalone and composite widgets.
        </li>
        <li>
        ...
        <li>
          <span className="text-bold">Composite Widgets</span> act as containers
          for standalond widgets, for example <code>menu</code>,{" "}
  ...
  <p>
    ...
    <span className="text-bold">properties</span> assign features to content.
    They both provide specific information and are therefore ofter mentioned
    together as <span className="text-bold">attributes</span>, but are
    conceptually different due to differences in use.
  </p>
  <p>
    For example, both states and properties can hold values such as true/false,
    numbers, strings, ID references and many more. However, the value of a
    property is often less likely &#40;if ever&#41; to change during an
    application's runtime. The opposite is true for states which may change
    often due to user interaction. It is important to know that there are
    exceptions for properties &#40; e.g. <code>aria-activedescendant</code>&#41;
    since its not a rule that their values cannot change. This is the reason for
    why states and properties are reffered to as attributes when possible,{" "}
    <em>there are barely any occasions where the distinction matters</em>. W3C's
    own clarification of the difference can be found{" "}
    <Link
  ...
  <ol>
    <li>
      If you can use a native HTML element with the semantics and behaviour you
      need already built in, then do so. Not all HTML5 elements have
  ...
  <p>
    When you need to add more descriptive labels to buttons or links, you can
  ...
  <p>
    <code>
      &#60;div class="alert-message"&#62;Error: Login not found.&#60;/div&#62;
    </code>
  </p>
  <p>After: </p>
  <p>
  ...
  <h3>Forms</h3>
  <p>
    You can add ARIA Attributes to input-fields to make forms more accessible.
    This makes the fields easier to interact with.
  </p>
  <p>For example:</p>
  <code>
  ...
  <h2>Parting words</h2>
  <p>
    My best tips for developing with ARIA is to start early and test lots. By
    navigating with only your keyboard and using a screen reader &#40;by
    utilizing an extension for your browser&#41; you'll quickly notice how your
    text is read. This will give you insights to, for example, if you've missed
    wrapping an abbreviation in a <code> &#60;abbr&#62;</code> tag and given it
    a aria-label, how lists are read with screen readers, that widgets are given
    roles and many more. Oftentimes these things can be missed by lighthouse
    reports, so{" "}
