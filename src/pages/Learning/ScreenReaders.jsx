...
<label id="chk15-label">Subscribe to the newsletter</label>`;
  ...
  const renderBreadCrumbs = () => (
    <Breadcrumbs aria-label="breadcrumb">
      {breadcrumbs.screenReaders.map((crumb, index) =>
        crumb.link ? (
  ...
  return (
    <>
      ...
      <Box component="section" sx={{ maxWidth: maxWidth }}>
        ...
        >
          Some people cannot use their eyes to receive information from
          webpages. To be able to browse the internet they have to use assistive
          technologies (AT) such as screen readers (e.g. JAWS or browser
          extensions) which will read the text on a webpage for them. But how
          can we make sure that this experience is as accessible as possible and
          easy to understand when our eyes can't help us? That's where ARIA
          comes in.
        </Typography>
      </Box>
      ...
      <Box component="section" sx={{ maxWidth: maxWidth }}>
        ...
        >
          ...
          web content accessible to users who Below we'll dive deeper into what
          ARIA is, when to, and when to not use it. Thanks to ARIA we can give
          semantic descriptions to content which doesn't natively exist in HTML
          or is missing full browser support. Simply put, ARIA was created for
          users who cannot use a mouse and must rely on their keyboard when
          browsing the web. When accessibility issues cannot be resolved with
